...
#######################################
    ...
    #      perturb one random user’s values (set to random), use as base dataset
    #      calculate L1 distance for user X’s recommendations
    #      calculate L1 distance for QII, by computing QII for user X using this dataset by perturbing values, as before 
