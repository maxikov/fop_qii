...
_start=$SECONDS
iteration_start=$SECONDS
until spark-submit --driver-memory 25g MovieLensALS.py --checkpoint-dir /home/maxikov/spark_dir --temp-dir /home/maxikov/spark_dir --spark-executor-memory 25g --local-threads "*" --lmbda 0.02 --num-iter 300 --non-negative --data-path datasets/ml-20m/ --movies-file datasets/ml-20m/ml-20m.imdb.medium.csv --tvtropes-file datasets/dbtropes/tropes.csv --num-partitions 7 --rank 12 --predict-metadata --metadata-sources years genres average_rating --cross-validation 70 --regression-model regression_tree --nbins 32 --drop-rare-features 100 --drop-rare-movies 10 --persist-dir ~/metadata_years_genres_tree.state  > logs/metadata_regression_years_genres_tree.txt
do
