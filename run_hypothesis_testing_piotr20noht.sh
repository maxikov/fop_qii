...
mkdir -p "${ALL_ROOT}/hypothesis_testing_piotr20noht"
ALL_ROOT="${ALL_ROOT}/hypothesis_testing_piotr20noht"
...
do
	...
	python synth_dataset_generator.py --specific-features "imdb_keywords:murder" "imdb_keywords:blood" "imdb_keywords:father-son-relationship" "imdb_keywords:title-spoken-by-character" "imdb_keywords:female-nudity" "movielens_genre:Thriller" "imdb_keywords:death" "imdb_keywords:husband-wife-relationship" "imdb_keywords:cigarette-smoking" "imdb_keywords:independent-film" "movielens_genre:Drama" "imdb_keywords:based-on-novel" "imdb_keywords:character-name-in-title" "imdb_keywords:friendship" "movielens_genre:Drama" "imdb_keywords:dog" "movielens_genre:Comedy" "imdb_keywords:kiss" "imdb_keywords:cult-film" "movielens_genre:Romance" --persist-dir ${ORIGINAL_STATE_DIR} --n-profiles 9 --n-users 2000 --mu 5 --sigma 1  --odir ${DATA_PATH} > ${LOG_DIR}/synth_data_set_generation_${NAME_SUFFIX}.txt
